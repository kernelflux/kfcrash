...
#define KFCRASH_HAS_CUSTOM_SYSCALL 1
...
#else
#define KFCRASH_HAS_CUSTOM_SYSCALL 0
...
#endif /* KFCRASH_HAS_CUSTOM_SYSCALL */
 ...
 */
#if !TARGET_OS_SIMULATOR && !TARGET_OS_OSX && KFCRASH_HAS_SYSCALL
        ...
        for (int i = 0; environ[i] != NULL; i++) {                                                \
            if (ksj_local_is_insert_libraries_env_var(environ[i])) {                              \
                ...
                break;                                                                            \
                                                                                                  ...
                                                                                                  \
        const char *sandboxpath = "/private/kfcrash_jailbreak_test";                              \
