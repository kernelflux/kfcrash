...
static void default_init(__unused KFCrash_ExceptionHandlerCallbacks *callbacks) {}
static KFCrashMonitorFlag default_monitorFlags(void) { return 0; }
...
static void default_addContextualInfoToEvent(__unused struct KFCrash_MonitorContext *eventContext) {}
static void default_notifyPostSystemEnable(void) {}
static KFCrashMonitorAPI g_defaultAPI = {
    .init = default_init,
...
bool kfccma_initAPI(KFCrashMonitorAPI *api)
{
